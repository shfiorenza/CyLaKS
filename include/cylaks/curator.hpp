...
private:
  ...
  Vec<Str> test_modes_{"xlink_bind_ii",
                       "xlink_diffusion",
                       "xlink_diffusion_Boltzmann",
                       "motor_lattice_bind",
                       "motor_lattice_step",
                       "hetero_tubulin",
                       "kinesin_mutant",
                       "filament_ablation",
                       "filament_separation",
                       "filament_forced_slide",
                       "shepherding"};
  Vec<Str> test_param_files_{"overlap", "prc1",    "prc1", "kif4a",
                             "kif4a",   "k401",    "k401", "endtag",
                             "overlap", "overlap", "k401"};
