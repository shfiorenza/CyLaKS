...
void ProteinManager::ReportTestStatistics() {
...
void ProteinManager::SetTestMode() {
  ...
  if (Sys::test_mode_ == "filament_ablation") {
    ...
    Sys::ErrorExit("ProteinManager::SetTestMode()");
  }
}

void ProteinManager::InitializeTest_Filament_Ablation() {
...
void ProteinManager::InitializeTest_Filament_Separation() {
...
void ProteinManager::InitializeTest_Filament_HeteroTubulin() {
...
void ProteinManager::InitializeTest_Motor_Heterodimer() {
...
void ProteinManager::InitializeTest_Motor_LatticeStep() {
...
void ProteinManager::InitializeTest_Motor_LatticeBind() {
...
void ProteinManager::InitializeTest_Xlink_Diffusion() {
...
void ProteinManager::InitializeTest_Xlink_Bind_II() {
  ...
  /*
  for (int i{0}; i < test_ref_.at("bind_ii").size(); i++) {
    printf("b(ub)[%i] = %#.3g (%#.3g)\n", i, test_ref_.at("bind_ii")[i],
           test_ref_.at("unbind_ii")[i]);
  }
  */
