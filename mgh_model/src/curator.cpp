...
void Curator::GenerateDataFiles(char *sim_name) {
  ...
  char occupancy_file[160], motor_ID_file[160], xlink_ID_file[160],
      tether_coord_file[160], mt_coord_file[160], motor_extension_file[160],
      xlink_extension_file[160], motor_force_file[160], xlink_force_file[160],
      total_force_file[160], motor_head_status_file[160];
...
void Curator::Log(const char *msg, T1 arg1, T2 arg2) {
