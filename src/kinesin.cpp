...
bool Kinesin::HasSatellite() { return false; }

int Kinesin::GetDirectionTowardRest() { return 0; }

double Kinesin::GetStalkCoordinate() { return 0.0; }

double Kinesin::GetTetherForce(Tubulin *site) { return 0.0; }

void Kinesin::UpdateExtension() { return; }
