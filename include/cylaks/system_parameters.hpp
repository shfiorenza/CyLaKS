...
inline double k_cata;
inline double k_resc;
inline double k_stab;
inline double k_grow;
inline double v_grow;
inline double v_shrink;
inline double k_spawn_soma;
inline double k_spawn_cyto;
inline double k_nucleate;
inline size_t nucleated_length;
inline double k_loss;
