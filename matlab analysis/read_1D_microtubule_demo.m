...
n_timesteps = 1000;   
mt_length = 1000;
n_max = 2000;      %shorthand for n_sites_max; corresponds to same thing
...
run_data = fread(fid1, [2*n_max, n_timesteps], '*int');
...
for ii=1:1:n_timesteps
    ...
    combined_mt_half_two(:, 1) = run_data(n_max+1:1:n_max + mt_length/2, ii);
