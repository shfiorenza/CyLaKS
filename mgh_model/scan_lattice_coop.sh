...
for EMAX_BULK in 1.5 #2.0 2.5 3.0
do
	for EMAX_SOLO in 0.75 # 0.75 1.0 1.25
	do
		for CONC_SCALE in 20 120 220 420
		do
			FILE_NAME="${SCAN_NAME}_${CONC_SCALE}"
			...
			N_STEPS=$(( 420 * 8000000 / $CONC_SCALE ))
