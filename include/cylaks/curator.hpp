...
private:
  ...
  Vec<Str> test_modes_{
      "xlink_bind_ii",      "xlink_diffusion",     "motor_lattice_bind",
      "motor_lattice_step", "hetero_tubulin",      "kinesin_mutant",
      "filament_ablation",  "filament_separation", "shepherding"};
  Vec<Str> test_param_files_{"overlap", "prc1",   "kif4a",   "kif4a", "k401",
                             "kif4a",   "endtag", "overlap", "k401"};
